...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen #F3F7F6] text-black flex flex-col items-center">
      <div className="relative w-full md:h-32 sm:h-80 bg-cover bg-center bg-bg-dashboard">
      ...
      <div className="container mx-auto h-auto p-4 flex justify-center flex-col items-center">
